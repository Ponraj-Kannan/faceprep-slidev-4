...
<div class="box1">
  ...
  <div class="box4" style="margin-top:0px">
    <div v-click class="box5" style="padding-top: 20px; font-weight: 500;">Nested If-Else</div>
    <div v-click class="box5" style="padding-top: 0px;">
    <div class="mini-container">Given a character <b>ch</b>, determine if it is a <b>Vowel</b>, <b>Consonant</b>, or <b>Not an Alphabet</b>.</div>
    </div>
