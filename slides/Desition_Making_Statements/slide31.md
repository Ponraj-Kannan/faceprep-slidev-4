...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div v-click class="mini-container-1" style="margin-bottom: 10px; margin-top: -10px;">Nested If-Else</div>
   <JavaRunner v-click/></div>
   <div class="container2" style="margin-top: 38px">
    <div v-click class="mini-container">Given a character <b>ch</b>, determine if it is a <b>Vowel</b>, <b>Consonant</b>, or <b>Not an Alphabet</b>.</div>
    </div>
  </div>
</div>