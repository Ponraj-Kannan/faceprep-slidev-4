...
<div class="box1">
  ...
  <div class="box4" style="margin-top:0px">
    <div v-click class="box5" style="padding-top: 20px; font-weight: 500;">If-Else Statement</div>
    <div v-click class="box5" style="padding-top: 0px;">
    <div class="mini-container">Check if a person is <b>eligible to vote based on their age</b> (age >= 18 Eligible or Not eligible).</div>
    </div>
