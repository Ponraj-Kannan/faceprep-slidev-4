...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div v-click class="mini-container-1" style="margin-bottom: 10px; margin-top: -10px;">If-Else Statement</div>
   <JavaRunner v-click/></div>
   <div class="container2" style="margin-top: 38px">
    <div v-click class="mini-container">Check if a person is <b>eligible to vote based on their age</b> (age >= 18 Eligible or Not eligible).</div></div>
  </div>
</div>