...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div v-click class="mini-container-1" style="margin-bottom: 10px; margin-top: -10px;">Bitwise Operators</div>
   <JavaRunner v-click/></div>
   <div class="container2" style="margin-top: 38px">
    <div v-click class="mini-container"> & AND</div>
    <div v-click class="mini-container"> | OR</div>
    <div v-click class="mini-container"> ^ XOR</div>
    <div v-click class="mini-container"> ~ NOT</div>
    <div v-click class="mini-container"> << Left Shift</div>
    <div v-click class="mini-container"> >> Right Shift</div>
