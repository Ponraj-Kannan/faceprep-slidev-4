...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div v-click class="mini-container-1" style="margin-bottom: 10px; margin-top: -10px;">Ternary Operator</div>
   <JavaRunner v-click/></div>
   <div class="container2" style="margin-top: 38px">
    <div v-click class="mini-container">( Condition ) ? ( True_value ) : ( False_value )</div>
