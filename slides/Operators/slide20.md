...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div v-click class="mini-container-1" style="margin-bottom: 10px; margin-top: -10px;">Arithmetic Operators</div>
   <JavaRunner v-click/></div>
   <div class="container2" style="margin-top: 38px">
    <div v-click class="mini-container">+ Addition</div>
    <div v-click class="mini-container">- Subtraction</div>
    <div v-click class="mini-container">* Multiplication</div>
    <div v-click class="mini-container">/ Division</div>
    <div v-click class="mini-container">% Modulus</div>
   </div>
  </div>
</div>
